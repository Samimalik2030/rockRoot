    ...
    <>
      ...
      <Stack gap={50}>
        ...
        <Card p={0} radius="md" style={{ overflow: "hidden" }}>
          <BackgroundImage
         h={300} 
            src="https://plus.unsplash.com/premium_photo-1682148134234-772b74827e56?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTYxfHxtYXJibGUlMjBmdXJuc2loZWQlMjByb29tc3xlbnwwfDB8MHx8fDA%3D"
